...
class DDPG(object):
    ...
    def train(
        ...
        for i in range(iterations):
            ...
            # Calculate Average and Max Action Values
...
# Create a network
network = DDPG(state_dim=state_dim, action_dim=action_dim, max_action=max_action)
